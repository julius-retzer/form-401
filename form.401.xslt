...
<div id="layoutCell103172" class="cell " >		
		...
		<input id="cbDovod" name="cbDovod" title="Musí byť zaškrtnuté, ak daňový subjekt podáva oznámenie z dôvodu opravy údajov uvedených v predchádzajúcom oznámení" type="checkbox" class="checkBox" value="Oznámenie podávam z dôvodu opravy údajov uvedených v predchádzajúcom oznámení, ktoré bolo správcovi dane podané dňa:" alt="Musí byť zaškrtnuté, ak daňový subjekt podáva oznámenie z dôvodu opravy údajov uvedených v predchádzajúcom oznámení"  ><xsl:if test="boolean(./*[name() = 'cbDovod']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'cbDovod']='1'"><xsl:attribute name="checked">checked</xsl:attribute></xsl:if></input><br />	
		<div class="clear"></div>
</div>							
...
<div id="layoutCell103173" class="cell " >		
		...
		<label class="fieldLabel" title="" for="dtpOznamDovodu" style="display: none">Dátum podania dôvodu opravy údajov uvedených v predchádzajúcom oznámení správcovi </label><span class="fieldContent"><input alt="" id="dtpOznamDovodu" name="dtpOznamDovodu" title="" type="text" class="date datepicker" maxlength="14" size="190"  ><xsl:if test="boolean(./*[name() = 'dtpOznamDovodu']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'dtpOznamDovodu']"/></xsl:attribute></input></span>	
		<div class="clear"></div>
</div>							
...
<div id="layoutCell103212" class="cell  kratkyTextBox120pxTitul" >		
		...
		<label class="fieldLabel" title="" for="tbRodneCislo" style="display: none">05 - Rodné číslo (pred lomkou) </label><span class="fieldContent"><input  id="tbRodneCislo" name="tbRodneCislo" title="Položka 'Rodné číslo' pozostáva z 9 alebo 10 čísel. Fyzická osoba musí povinne uviesť DIČ, RČ alebo Dátum narodenia." type="text" class="textBox" maxlength="6" size="190"  alt="Položka 'Rodné číslo' pozostáva z 9 alebo 10 čísel. Fyzická osoba musí povinne uviesť DIČ, RČ alebo Dátum narodenia." value=""  ><xsl:if test="boolean(./*[name() = 'tbRodneCislo']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'tbRodneCislo']/text()"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'tbRodneCislo']"/></xsl:attribute></xsl:if></input></span>	
		<div class="clear"></div>
</div>							
...
<div id="layoutCell104297" class="cell  kratkyTextBox120pxTitul" >		
		...
		<label class="fieldLabel" title="" for="tbRodneCislo_2" style="display: none">05 -Rodné číslo (za lomkou) </label><span class="fieldContent"><input  id="tbRodneCislo_2" name="tbRodneCislo_2" title="" type="text" class="textBox" maxlength="4" size="190"  alt="" value=""  ><xsl:if test="boolean(./*[name() = 'tbRodneCislo_2']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'tbRodneCislo_2']/text()"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'tbRodneCislo_2']"/></xsl:attribute></xsl:if></input></span>	
		<div class="clear"></div>
</div>							
...
<div id="layoutCell103216" class="cell  kratkyTextBox120pxTitul" >		
		...
		<label class="fieldLabel" title="" for="dtpDatNarodenia" style="display: none">06 - Dátum narodenia </label><span class="fieldContent"><input alt="Fyzická osoba musí povinne uviesť DIČ, RČ alebo Dátum narodenia." id="dtpDatNarodenia" name="dtpDatNarodenia" title="Fyzická osoba musí povinne uviesť DIČ, RČ alebo Dátum narodenia." type="text" class="date datepicker" maxlength="14" size="190"  ><xsl:if test="boolean(./*[name() = 'dtpDatNarodenia']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'dtpDatNarodenia']"/></xsl:attribute></input></span>	
		<div class="clear"></div>
</div>							
...
<div id="layoutCell103175" class="cell  sirokyTextBox410px" >		
		...
		<label class="fieldLabel" title="" for="tbOdd3Vypracoval" style="display: none">Vypracoval </label><span class="fieldContent"><input  id="tbOdd3Vypracoval" name="tbOdd3Vypracoval" title="" type="text" class="textBox" maxlength="50" size="190"  alt="" value=""  ><xsl:if test="boolean(./*[name() = 'tbOdd3Vypracoval']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:if test="./*[name() = 'tbOdd3Vypracoval']/text()"><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'tbOdd3Vypracoval']"/></xsl:attribute></xsl:if></input></span>	
		<div class="clear"></div>
</div>							
...
<div id="layoutCell103178" class="cell " >		
		...
		<label class="fieldLabel" title="" for="tbOdd3Dna" style="display: none">Dňa </label><span class="fieldContent"><input alt="" id="tbOdd3Dna" name="tbOdd3Dna" title="" type="text" class="date datepicker" maxlength="14" size="190"  ><xsl:if test="boolean(./*[name() = 'tbOdd3Dna']/@isReadOnly = 'true')"><xsl:attribute name="disabled">disabled</xsl:attribute></xsl:if><xsl:attribute name="value"><xsl:value-of select="./*[name() = 'tbOdd3Dna']"/></xsl:attribute></input></span>	
		<div class="clear"></div>
</div>							
